...
45. **Going public: early merge to main + successor branch
    ...
    `main` → the plan branch is RETIRED.
    **EXECUTED 2026-08-09**: PR #51 merged (`aeeec23`);
    `claude/plan-completion` cut from that merge and pushed.
    This doc is maintained on the successor branch from here;
    the SFX handoff to the collaborator happens via a
    transfer prompt generated by the PR #79 session after it
    completes the #45a rebase/retarget. Remaining roadmap
