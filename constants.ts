...
export const GRAVITATIONAL_LENS_CONSTANTS = {
  RADIUS: 100,             // Max effect radius (CSS pixels)
  TILE_SIZE: 16,           // Displacement grid tile size — larger = fewer drawImage calls (~150 tiles)
  PEAK_DISPLACEMENT: 8,    // Max pixel displacement at Einstein ring radius
  SOFTENING: 40,           // Einstein ring radius (CSS pixels) — where displacement peaks
