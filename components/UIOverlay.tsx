    ...
    <div className="font-mono text-[9px] leading-tight text-slate-300/90">
              ...
              {!collapsed.player && (<>
                ...
                {ctrlRow('Roll feel', onCyclePlayerRoll, stats.rollFeelName ?? 'Default',
                  'Banking-roll depth preset (Off / Subtle / Default / Deep) stepping how far the hull rolls into lateral thrust — purely visual (physics, collision and aim never read it). Off levels out through the normal easing rather than snapping flat.')}
