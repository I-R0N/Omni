    ...
    <div className="font-mono text-[9px] leading-tight text-slate-300/90">
              ...
              {!collapsed.player && (<>
                ...
                {ctrlRow('Hull', onCyclePlayerHull, stats.hullModeName ?? 'Cube',
                  'What draws at the player\'s position. Cube (default): a flat wireframe cube — at rest a square with the nose face edge-on — rotating for real in yaw + the tilt pitch/roll. Diamond: the same cube stood on a corner for a gem-cut hull. Sphere: three great circles with a nose ring at the forward pole. Dodeca: a dodecahedron with a pentagonal face forward. Rhombic: the rhombic dodecahedron, axis vertex forward. Tri: a triangular dart ship — nose, swept wingtips, dorsal peak and keel. Ship: the sprite with the cos-tilt squash, kept as the A/B.')}
