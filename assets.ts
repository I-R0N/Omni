...
// the DBG panel's nebula-set cycle.  These crop tighter than the legacy
// art, so the RenderSystem nebula-sizing toggles (NbFit / NbBig) exist to
// make them render oversized instead of fitting the collision outline.
