...
export class GameEngine {
  ...
  public skipWave() {
    ...
    this.onStatsUpdate({
      ...
      starDensityName: getActiveStarDensityName(),
      starSizeName: getActiveStarSizeName(),
      starBandsName: getActiveStarBandsName(),
      starRegionName: getActiveStarRegionName(),
      starMotionName: getActiveStarMotionName(),
